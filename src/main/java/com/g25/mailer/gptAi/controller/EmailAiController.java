package com.g25.mailer.gptAi.controller;

import com.g25.mailer.gptAi.dto.AutoGenerateRequest;
import com.g25.mailer.gptAi.dto.AutoGenerateResponse;
import com.g25.mailer.gptAi.dto.RefineRequest;
import com.g25.mailer.gptAi.dto.RefineResponse;
...
@Tag(name = "GPT AI 메일 서비스", description = "GPT AI를 이용한 메일 자동 생성 및 교정 API")
public class EmailAiController {
    ...
    @Operation(summary = "GPT AI 메일 자동 생성", description = "사용자가 입력한 프롬프트를 기반으로 GPT AI가 메일 내용을 자동 생성합니다.")
    @ApiResponses({
     ...
     */
    @PostMapping("/refine")
    @Operation(summary = "GPT AI 메일 문법·어투 교정", description = "사용자가 작성한 메일 내용을 GPT AI가 문법과 어투를 교정합니다.")
    @ApiResponses({
