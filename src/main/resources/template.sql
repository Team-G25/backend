...
INSERT INTO templates (title, content, target_id, keyword1_id, keyword2_id) VALUES
    ...
    (
        '[출결 관련 문의] 결석 알림 및 제출문서 문의',
        '안녕하세요 교수님,

        저는 [이름]입니다. [날짜]에 진행된 [과목명] 수업에 부득이한 사정으로 결석하게 되어 이렇게 연락드립니다.
        결석 사유는 [결석 사유 – 예: 개인 사정, 병원 진료, 가족 행사 등]이며, 이에 따라 출석 처리나 대체 과제 제출 등의 조치가 필요한지 여쭙고자 합니다.

        추후 수업에 불이익이 없도록 필요한 절차나 준비사항이 있다면 안내해 주시면 감사하겠습니다.

        바쁘신 중에도 확인해 주셔서 감사드리며, 회신 기다리겠습니다.
        감사합니다.
    ...
    (
        ...
        저는 [이름]입니다. [과목명] 성적 확인과 관련하여 문의드리고자 연락드립니다.

        성적 열람이 가능한 날짜와 시간, 장소를 안내해 주실 수 있을까요?
        또한, 별도의 신청이나 절차가 필요한 경우 사전에 준비할 사항이 있는지도 함께 알려주시면 감사하겠습니다.

        바쁘신 와중에도 귀한 시간 내어주셔서 감사드리며, 회신 기다리겠습니다.
    ...
    (
        ...
        저는 [이름]입니다. 지난 [과제명] 과제를 내주셨는데, 과제에 대한 추가적으로 여쭙고 싶어 문의드립니다.

        혹시 [과제 평가 일정이 언제쯤 진행될 예정인지] 안내해 주실 수 있을까요?
        또한, [평가 기준에 대한 추가 설명]이 가능하다면 알고 싶습니다.

        추가로 보완해야 할 사항이 있다면 알려주시면 감사하겠습니다.
        바쁘신 와중에도 확인해 주셔서 감사합니다.
    ...
    바쁘시겠지만 검토해 주시면 감사하겠습니다. 관련 자료는 첨부파일/링크로 함께 전달드리겠습니다.
